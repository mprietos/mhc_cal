...
export const CONFIG = {
  ...
  // Pistas de equipos rivals (clau: nom normalitzat sense accents en majúscules).
  awayVenues: {
    ...
    'HOQUEI CASAL ESPLUGA A':   "Pavelló David Rovira i Minguella, Carrer del Sere s/n, L'Espluga de Francoli",
    'HOQUEI CASAL ESPLUGA B':   "Pavelló David Rovira i Minguella, Carrer del Sere s/n, L'Espluga de Francoli",
    'ROTOTANK BIGUES I RIELLS': "Pavelló Municipal Les Cremades, Cami del Veinat 5, Bigues i Riells",
